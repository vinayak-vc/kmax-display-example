...
namespace KmaxXR
{
    ...
    public class KmaxUIRaycaster : BaseRaycaster
    {
        private static List<KmaxUIRaycaster> uilist = new List<KmaxUIRaycaster>();
        public static IEnumerable<KmaxUIRaycaster> UIList => uilist;
        ...
        public static void RaycastAll(Ray ray, List<RaycastResult> raycastResultCache,
            float maxDistance, int layerMask)
        {
            foreach (var item in UIList)
            {
                item.Raycast(ray, raycastResultCache, maxDistance, layerMask);
            }
        }
    }
}